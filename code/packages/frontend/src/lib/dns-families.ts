...
export const DNS_FAMILIES: DnsFamilyDef[] = [
  {
    ...
    label: "MX routing",
    meaning: "Can the world route mail to this domain — and bounces and reports back to you?",
  ...
  },
  {
    ...
    meaning: "Is mail to this domain encrypted in transit with a valid, matching certificate?",
  ...
  },
  {
    ...
    header: "MTA-STS",
    label: "MTA-STS",
    meaning: "Is there a downgrade-resistant TLS policy that senders must honor?",
    prefixes: ["mta_sts"],
  },
  {
    key: "tls_rpt",
    ...
    header: "TLS-RPT",
    label: "TLS-RPT",
    meaning: "Will anyone tell you when senders can't negotiate TLS with your MX?",
    prefixes: ["tls_rpt"],
  },
  {
    key: "dane_tlsa",
  ...
  // The bare "dnssec" prefix catches checker-scoped ids (infra.dnssec.error, .did_not_complete).
  {
    ...
    header: "DNSSEC",
    label: "DNSSEC",
    meaning: "Are this zone's DNS answers cryptographically signed — and validly so?",
  ...
  },
  {
    ...
    meaning: "Will every receiver's resolver get a fast, consistent, honest answer?",
    prefixes: [
      "ns_",
      "soa_",
      "ttl_sanity",
  ...
  },
  {
    ...
    meaning: "Does the registration look stable, locked, and mature — not throwaway?",
    prefixes: [
  ...
  },
  {
    ...
    meaning: "Is the mail server itself abusable — open relay, enumeration, plaintext auth?",
